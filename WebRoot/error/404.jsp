...
<%@ include file="../WEB-INF/basePath.jsp" %>
<meta http-equiv=content-type content="text/html; charset=gb2312">
<meta http-equiv=refresh content=2;url=admin/main.htm />
<style type=text/css>
.font14 {
	font-size: 14px
}
			...
			<tr>
				<td valign=top>
					<div class=font14 align=center>
						...
						</strong><span class=font12><font color=#666666>2秒后自动返回<a
								href="admin/main.htm"><%=Config.get().getSiteName() %></a>后台系统........ </font>
						</span>
					</div>
				</td>
			</tr>
