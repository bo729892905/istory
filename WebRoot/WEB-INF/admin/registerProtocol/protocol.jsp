...
<div id="page-content" class="clearfix" >
  ...
  <div class="row-fluid" style="padding-top: 5% ">
	  <form class="form-horizontal" id="validation-form" method="post">
 		  <textarea id="content" name="content" style="width: 50%;height:300px; " maxlength="10000">${registerProtocol.content}</textarea>
 	 </form>
  ...
  <div style="text-align: left; padding-left: 15%">
		...
		$(function() {
			...
			$("#submit").click(function(){
				bootbox.confirm("确定修改“注册协议”吗？", function(result) {
					if(result){
						var data = {
