  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center" style="width:15%">内容</th>
					...
					<c:when test="${not empty chapterList}">
						<c:forEach items="${chapterList}" var="chapter" varStatus="vs">
							<tr>
								...
								<td class="center">${chapter.text }</td>
		...
		<table style="width:100%;">
			<tr>
				<td style="vertical-align:top;"><a class="btn btn-small btn-primary" onclick="addChapter();">添加</a></td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function toBack(){
			top.mainFrame.tabAddHandler("scriptFactoryList","剧本工厂列表","admin/scriptFactory/list.htm?tm="+new Date().getTime());
		}
		function toList(id){
			top.mainFrame.tabAddHandler("scriptFactoryChapterInfo","剧本场次详情","admin/scriptFactory/chapterInfo.htm?id="+id+"&scriptId="+$("#sid").val());
		}
		function addChapter(id){
			top.mainFrame.tabAddHandler("scriptFactoryChapterInfo"," 新增剧本场次","admin/scriptFactory/chapterInfo.htm?scriptId="+$("#sid").val());
		}
