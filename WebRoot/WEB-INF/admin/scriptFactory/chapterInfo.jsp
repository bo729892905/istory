...
<div id="page-content" class="clearfix" >
  ...
  <div class="row-fluid" style="padding-top: 5% ">
	  <form class="form-horizontal" id="validation-form" method="post">
	 	 	<input type="hidden" value="${scriptChapter.id}" id="id">
	 		 <input type="hidden" value="${scriptId}" id="scriptId">
 		  	<textarea id="text" name="text" style="width: 50%;height:300px; " maxlength="10000">${scriptChapter.text}</textarea>
 	 </form>
  ...
  <div style="text-align: left; padding-left: 15%">
		...
		$(function() {
			...
			$("#submit").click(function(){
				bootbox.confirm("确定修改场次内容吗？", function(result) {
					if(result){
						var data = {
								"id":$("#id").val(),
						...
						$.post("admin/scriptFactory/chapterEdit.htm", data, function(request) {
							var json = eval('(' + request + ')'); 
							if(1 == json.status){
								top.mainFrame.tabAddHandler("scriptFactoryList","剧本场次列表","admin/scriptFactory/chapterList.htm?id="+$("#scriptId").val());
							}else{
