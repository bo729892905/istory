		...
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form class="form-horizontal" id="validation-form" method="post">
					<div class="control-group">
						...
						<div class="controls" >
							<div class="span12">
								<input type="hidden" name="id" id="id" value="${storyIsland.id }" >
								<input type="text" readonly="readonly" name="title" id="title" value="${storyIsland.title }" >
							</div>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<span class="span12"><input type="text" readonly="readonly" name="author" id="author" value="${storyIsland.author }" > 
							</span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<span class="span12"><input type="text" readonly="readonly" name="releaseTime" id="releaseTime" value="${storyIsland.releaseTime }" > 
							</span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<div class="span12">
								<a href="${storyIsland.cover}" target="_blank"><img src="${storyIsland.cover }" width="210"></a>
							</div>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<span class="span12"> <input type="text"  name="hot" id="hot" value="${storyIsland.hot }" > 
							</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="choiceness">精选:</label>
						<div class="controls">
							<label><input type="checkbox" class="ace-switch ace-switch-3" id="choiceness" <c:if test="${storyIsland.choiceness == 1 }">checked="checked" </c:if>  onclick="kf_qx1(this.id)">
...
<script type="text/javascript">
var value = "${storyIsland.choiceness}" == "1"?1:0;
debugger
$(document).ready(function(){
	$("#submit").click(function(){
		...
		if(vailVals()!=0){
		 ...
		 bootbox.confirm("你将修改故事信息！","取消","确定",function(e){
			if(e){
				var data = {
					"id":$("#id").val(),
					"hot":$("#hot").val(),
				...
				$.post("admin/storyIsland/updateChoicenessAndHot.htm", data, function(request) {
					var json = eval('(' + request + ')'); 
					if(1 == json.status){
						$("#div_content").hide();
						top.Dialog.close();
						targetMainFrame("admin/storyIsland/list.htm");
					}else{
