		...
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form class="form-horizontal" id="validation-form" method="post">
					<div class="control-group">
						...
						<div class="controls" >
							<div class="span12">
								<input type="text"  name=roleName id="roleName"  placeholder="请输入角色名" />
							</div>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<span class="span12"> <textarea rows="3" id="description"></textarea>
							</span>
						</div>
					</div>
...
$(document).ready(function(){
	$("#submit").click(function(){
		...
		if(vailVals()!=0){
		 ...
		 bootbox.confirm("你将新增角色！","取消","确定",function(e){
			if(e){
				var data = {
					"id":$("#id").val(),
				...
				//action="user/addUser"
				$.post("admin/adminRole/add.htm", data, function(request) {
