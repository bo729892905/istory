		...
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls">
							<span class="span12"><input readonly="readonly" type="text"  name="number" id="number" value="${number }" > 
							</span>
						</div>
					</div>
					<div class="control-group">
...
$(document).ready(function(){
	...
	$("#submit").click(function(){
		...
		if(vailVals()!=0){
		 ...
		 bootbox.confirm("你将新增星故事信息！","取消","确定",function(e){
			if(e){
				$.post("admin/starStory/add.htm", $("#validation-form").serialize(), function(request) {
