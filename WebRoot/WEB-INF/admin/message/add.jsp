		...
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form class="form-horizontal" id="validation-form" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<div class="span12">
								<textarea  style="width: 80%" rows="8" name="content" id="content" placeholder="请输入消息内容"></textarea>
							</div>
						</div>
					</div>
...
$(document).ready(function(){
	$("#submit").click(function(){
		...
		if(vailVals()!=0){
		 ...
		 bootbox.confirm("你将新增消息！","取消","确定",function(e){
			if(e){
				var data = {
					"title":$("#title").val(),
					"content":$("#content").val(),
				...
				//action="user/addUser"
				$.post("admin/message/add.htm", data, function(request) {
