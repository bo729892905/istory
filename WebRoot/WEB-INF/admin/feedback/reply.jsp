...
<div class="container-fluid" id="main-container">
	<div class="row-fluid">
			...
			<form class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls" style="padding-left: 30px;">
							<span class="span12"> <textarea style=" width: 88%" rows="8" name="reply" id="reply">${feedback.reply}</textarea>
							</span>
						</div>
					</div>
		...
		<div class="form-actions"   style="padding-left: 20%;padding-top: 30px">
...
$(document).ready(function(){
	...
	$("#submit").click(function(){
		...
		if(vailVals()!=0){
		 ...
		 bootbox.confirm("你将保存回复！","取消","确定",function(e){
			if(e){
				$.post("admin/feedback/save.htm", $("#validation-form").serialize(), function(request) {
					var json = eval('(' + request + ')'); 
					if(1 == json.status){
						$("#div_content").hide();
						top.Dialog.close();
						targetMainFrame("admin/feedback/list.htm");
					}else{
...
function vailVals(){
	...
	if(!checkField($("#reply").val(), 1,2000)){
		valTips('reply', '请填写回复');
		return 1;
	}
	return 0;
