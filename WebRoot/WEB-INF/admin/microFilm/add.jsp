						...
						<div class="controls">
								<div class="radio">
									<label class="radio-inline" >
									 <input  type="radio" style="opacity:1" name="filmType" id="filmType" value="1" <c:if test="${microFilm.filmType==1}">checked="checked"</c:if>  > 影院
									 &nbsp;&nbsp;&nbsp;
									 <input type="radio" style="opacity:1"  name="filmType" id="filmType" value="0"  <c:if test="${microFilm.filmType==0}">checked="checked"</c:if>  > 原创
									 </label>
								 </div>
						</div>
					</div> --%>
