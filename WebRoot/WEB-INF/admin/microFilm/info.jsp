...
<div id="page-content" class="clearfix" >
  ...
  <div class="row-fluid" style="padding-top: 5% ">
	  <form class="form-horizontal" id="validation-form" method="post">
 		  <textarea id="content" name="content" style="width: 50%;height:300px; " maxlength="10000">${uploadInstructions.content}</textarea>
 	 </form>
  ...
  <div style="text-align: left; padding-left: 15%">
		...
		$(function() {
			...
			$("#submit").click(function(){
				...
				bootbox.confirm("确定修改“上传说明”吗？", function(result) {
					if(result){
						var data = {
								"content":contentEditor.html(),
							};
						$.post("admin/uploadInstructions/edit.htm", data, function(request) {
