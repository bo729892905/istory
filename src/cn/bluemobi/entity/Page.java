...
public class Page {
	...
	private int showCount; //每页显示记录数  1
	private int totalPage;		//总页数
	private int totalResult;	//总记录数 2
	private int currentPage;	//当前页 3
	...
	public String getPageStr() {
		...
		if(totalResult>=0){
			...
			if(startTag>1){
				sb.append("<li><a><font color='#808080'>...</font></a></li>\n");
			}
